...
PAI1 = dumbPAI(weightFile='PAI1_weights4000.txt')
PAI2 = dumbPAI(weightFile='PAI2_weights4000.txt')
...
for i in range(numGames):
    ...
    if (i%1000) == 0:
        fileName = 'PAI1_weights%d.txt' % (4000+i)
        f = open(fileName, 'w')
        json.dump(PAI1.weights, f)
        f.close()
        fileName = 'PAI2_weights%d.txt' % (4000+i)
        f = open(fileName, 'w')
